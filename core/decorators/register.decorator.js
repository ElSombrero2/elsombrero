        ...
        obj.controllers.map(function (constructor) {
            ...
            keys.map(function (key) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    fun.apply(obj.context, __spreadArray(__spreadArray(__spreadArray([path + data.url], middlewares, true), data.middlewares, true), [function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                            var result, e_1;
                            var _a, _b;
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    ...
                                    case 2:
                                        e_1 = _c.sent();
                                        res.status(e_1.httpStatus || 500).json({
                                            status: e_1.httpStatus || 500,
                                            title: e_1.title,
                                            message: e_1.detail || 'Internal Server Error.'
                                        });
                                        return [3 /*break*/, 3];
